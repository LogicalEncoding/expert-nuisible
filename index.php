    ...
    <body>
        ...
        <div id="main_content">
            ...
            <div class="container_sheet main_content_article">
                <h3>Expert nuisible : des professionnels à votre écoute</h3>
                <p>Depuis 2002, Hss Expert nuisible, entreprise à taille humaine, se charge de la <strong>dératisation, désinsectisation et la désinfection</strong> de vos locaux pour professionnels et particuliers.</p>
                <p>Nous éradiquons efficacement les souris, rats, cafard, blattes punaises de lit, puces et tout autres nuisibles.</p>
                <p>Des techniciens à  l'écoute du client. Une écoute et des conseils de 9h00 à 18h00.</p>
                <p>L'expérience, la réactivité et les compétences. Notre équipe de professionnels vous apporte compétence et savoir-faire pour mettre en oeuvre nos solutions les plus efficaces.</p>
            </div>
        </div>
