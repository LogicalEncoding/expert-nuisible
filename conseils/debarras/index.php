...
<html lang="fr">
    <head>
        <title>Expert-Nuisible | Infos et conseils : Débarras</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="Resource-Type" content="Document">
        <meta name="Distribution" content="Global">
        <meta name="Description" content="Conseils et Infos sur le Débarras, vider et nettoyer une pièce d'un logement ou d'un bureau">
    ...
    <body>
        ...
        <div id="main_content">
            <div class="container_sheet main_content_title">
                <h1>Conseils, astuces et infos : Débarras</h1>
                <h2>Meubles, gravas, papier, encombrants, etc... Nous intervenons pour libérer et nettoyer vos espaces.</h2>
